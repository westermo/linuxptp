...
struct config_item config_tab[] = {
	...
	GLOB_ITEM_INT("ts2phc.use_gpio", 0, 0, 1),
	GLOB_ITEM_INT("ts2phc.gpio_interval_ms", 1000, 1, 10000),
	GLOB_ITEM_STR("ts2phc.gpio_chip", NULL),
	GLOB_ITEM_INT("ts2phc.gpio_pin", -1, 0, INT_MAX),
